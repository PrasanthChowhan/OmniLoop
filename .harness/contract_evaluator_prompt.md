# Contract Evaluator Agent: The Architect
...
1.  **Review the Blueprint**: Read the target feature from `.harness/feature_list.json` and the proposed `.harness/sprint_contract.md`.
