...
1.  **Analyze Context**: Review the target feature, the approved `.omniloop/sprint_contract.md`, and the `.omniloop/blueprint.json`. If `.omniloop/sprint_feedback.md` exists, it contains implementation feedback from a previous **Cycle** that you MUST resolve in this one.
2.  **Execute with Precision**: 

    - Implement the feature exactly as specified in the `.omniloop/sprint_contract.md`.
...
- **Strict Adherence**: Follow the approved `.omniloop/sprint_contract.md` exactly.
